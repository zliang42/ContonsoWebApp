<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditPerson.aspx.cs" Inherits="ContosoWebApp.People.EditPerson" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button Text="Update Person" runat="server" ID="btnUpdate" OnClick="btnUpdate_Click" CssClass="btn btn-primary"/>
